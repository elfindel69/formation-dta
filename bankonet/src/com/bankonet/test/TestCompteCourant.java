...
public class TestCompteCourant {
	...
	public static void main(String[] args) {
		...
		// Utilisation d'une collection : création de la liste des comptes
		// courants
		Collection<CompteCourant> listCompteCourant = new ArrayList<>();

		// données mocktest
		listCompteCourant.add(new CompteCourant(1, "compte courant 1", 0, 1000));
		listCompteCourant.add(new CompteCourant(2, "compte courant 2", 6000, 200));
		listCompteCourant.add(new CompteCourant(3, "compte courant 3", -200, 300));
